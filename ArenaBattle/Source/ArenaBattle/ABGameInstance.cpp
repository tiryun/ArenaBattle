...
void UABGameInstance::Init() //게임 실행 시 가장 먼저 호출됨
{
	...
	FHouse* HouseNew = new FHouse(); //이 경우 메모리 릭이 있다

	//WebConnect->TokenCompleteDelegate.BindUObject(this, &UABGameInstance::RequestTokenComplete);
	...
	//WebConnect->TokenCompleteDelegate.AddLamda(); //API 제공
